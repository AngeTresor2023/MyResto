...
import englishData from '@/components/i18n/en.json' // Importation des données de traduction anglaises
import frenchData from '@/components/i18n/fr.json' // Importation des données de traduction françaises
